...
public class Scanner {
	...
	static Scanner() {
		...
		for (int i = 99; i <= 99; ++i) start[i] = 2;
		for (int i = 101; i <= 101; ++i) start[i] = 2;
		for (int i = 103; i <= 122; ++i) start[i] = 2;
		start[34] = 3; 
		start[43] = 6; 
		start[45] = 7; 
		start[63] = 8; 
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "DIV": t.kind = 16; break;
			case "mod": t.kind = 17; break;
			case "MOD": t.kind = 18; break;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 32:
				recEnd = pos; recKind = 2;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'n' || ch >= 'p' && ch <= 'z') {AddCh(); goto case 2;}
				else if (ch == 'o') {AddCh(); goto case 35;}
				else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 33:
				recEnd = pos; recKind = 2;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'd' || ch >= 'f' && ch <= 'z') {AddCh(); goto case 2;}
			...
			case 34:
				recEnd = pos; recKind = 2;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'e' || ch >= 'g' && ch <= 'z') {AddCh(); goto case 2;}
			...
			case 39:
				...
				else if (ch == 'k') {AddCh(); goto case 41;}
				else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 40:
				recEnd = pos; recKind = 2;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 't' || ch >= 'v' && ch <= 'z') {AddCh(); goto case 2;}
			...
			case 42:
				recEnd = pos; recKind = 2;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 'k' || ch >= 'm' && ch <= 'z') {AddCh(); goto case 2;}
				else if (ch == 'l') {AddCh(); goto case 43;}
				else {t.kind = 2; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 43:
				recEnd = pos; recKind = 2;
				if (ch >= '0' && ch <= '9' || ch >= 'A' && ch <= 'Z' || ch >= 'a' && ch <= 's' || ch >= 'u' && ch <= 'z') {AddCh(); goto case 2;}
